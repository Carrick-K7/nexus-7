...
Human Observatory 是默认入口，按“项目是什么 → 今天发生什么 → 谁受影响 →
为什么 → 是否可信”组织信息。它展示人口语义、全部 260 个单位、社区、机构、
生产链、趋势、事件和证据，并明确区分固定的 100% 软件控制覆盖率与动态链路
顺畅度。

合成情绪、AI 参与感、机器人耐久度和机构流畅度都是有版本公式的确定性投影，
不构成意识或现实机构声明。表格支持搜索、筛选、分页、键盘与移动端；JSON
