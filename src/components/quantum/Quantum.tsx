  ...
  return (
    <div className="p-6 space-y-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-3xl font-orbitron font-bold text-cyber-purple cyber-text-glow">QUANTUM CORE</h1>
        <p className="text-cyber-text-dim mt-1">Quantum computing and entanglement visualization</p>
      </motion.div>

      <div className="grid grid-cols-4 gap-4">
        {[
          { label: "Qubits", value: qubits.length, icon: Circle, color: "cyber-blue" },
          { label: "Superposition", value: superpositionCount, icon: Atom, color: "cyber-purple" },
          { label: "Entanglements", value: entanglements.length, icon: Lock, color: "cyber-pink" },
          { label: "Coherence", value: "94%", icon: Activity, color: "cyber-green" },
        ].map((stat, i) => (
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            <h3 className="text-lg font-orbitron text-cyber-text mb-6">Quantum Bit Visualization</h3>
            ...
            <div className="flex gap-4 mt-4">
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className="text-cyber-text-dim">State |0</span>
              </div>
              <div className="flex items-center gap-2 text-xs">
                <div className="w-3 h-3 rounded-full bg-cyber-red" />
                <span className="text-cyber-text-dim">State |1</span>
              </div>
              <div className="flex items-center gap-2 text-xs">
                <div className="w-3 h-3 rounded-full bg-cyber-purple" />
                <span className="text-cyber-text-dim">Superposition</span>
              </div>
            </div>
        ...
        <div className="space-y-4">
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}
            ...
            <h3 className="text-sm font-orbitron text-cyber-text mb-3">Quantum Gates</h3>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}
            className="bg-cyber-dark/50 border border-cyber-blue/20 rounded-xl p-4">
            <h3 className="text-sm font-orbitron text-cyber-text mb-3">Processing Power</h3>
            <div className="text-center py-4">
              <div className="text-3xl font-bold text-cyber-purple">2^8</div>
              <div className="text-xs text-cyber-text-dim">= 256 possible states</div>
            </div>
            ...
            <div className="text-xs text-cyber-text-dim mt-1">35% utilization</div>
          </motion.div>
        </div>
      </div>
    </div>
