...
describe("human observatory projection", () => {
  it("projects every software unit, institution, and AI-controlled production stage", () => {
    ...
    const shadowDecision: CognitiveDecision = {
      ...deepSeekDecision,
      id: `${current.season.id}-deepseek-shadow-observatory-test`,
      residentId: current.residents[2].id,
      provider: "nexus-deterministic-reference",
      model: "bounded-resident-policy-v1",
      requestedProvider: "nexus-deterministic-reference",
      ...
      billing: undefined,
      shadow: {
        schemaVersion: "nexus.cognitive-shadow.v1",
        requestedProvider: "deepseek-chat-completions",
        providerRequestId: "shadow-observatory-request",
        status: "observed",
        externalCallAttempted: true,
        provider: "deepseek-chat-completions",
        model: "deepseek-v4-flash",
        disposition: "decline",
        disagreesWithPrimary: true,
    ...
    expect(projection.cognition).toMatchObject({
      ...
      configuredShadowProvider: "deepseek-chat-completions",
      deepseek: {
        externalCallAttempts: 3,
        successfulDecisions: 2,
        fallbackDecisions: 1,
        inputTokens: 180,
        cacheHitInputTokens: 40,
        cacheMissInputTokens: 140,
        outputTokens: 30,
        totalTokens: 210,
        costUsd: 0.00002751,
        ...
        shadow: {
          ...
          costUsd: 0.000005,
          latestBilledTurn: current.turn.turn,
          pricingVersions: ["deepseek-v4-usd-2026-04-24"],
