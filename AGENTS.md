...
- v4.2.0 Tag/分支已 push；`9df53ed` 已部署至 `nexus7.carrick7.com`，匿名
  只读 Human Observatory、双层写阻断、Turn 8 与升级前后备份已验证。
- 尚无 v4.2 的远端 Sigstore receipt；live DeepSeek、外部恢复演练和第二数据库
