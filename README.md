...
The active production release is **v4.8.11 — Release Evidence Identity
Closure**. It closes the generated-output inventory and pre-attestation claim
gaps without changing city settlement.
